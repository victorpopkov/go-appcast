...
func TestSparkleRSSFeedAppcastExtractReleases(t *testing.T) {
	testCases := map[string]map[string][]string{
		...
		"sparkle_only_version.xml": {
			"2.0.0": {"2016-05-13 12:00:00 +0200 +0200", "2.0.0", "https://example.com/app_2.0.0.dmg", "10.10"},
			"1.1.0": {"2016-05-12 12:00:00 +0200 +0200", "1.1.0", "https://example.com/app_1.1.0.dmg", "10.9"},
